...
<body style="background-color: #f2f2f2; color: #333;">
    ...
    <div class="container-fluid px-5 py-5">
        <div class="card shadow p-4" style="border-radius: 20px; border: 2px solid #6fcf97; background-color: #e9e9e9;">
            ...
            <h2>Pagos</h2>
            <a href="{{ route('payments.create') }}" class="btn" style="background-color: #6fcf97; color: white; border-radius: 10px; padding: 10px 20px;">+ Crear Pago</a>
        </div>
        ...
        @if ($payments->isEmpty())
            <div class="alert alert-warning">No hay pagos. <a href="{{ route('payments.create') }}">Crear uno</a></div>
        @else
                ...
                <tbody>
                    @foreach ($payments as $payment)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('payments.show', $payment->id) }}" class="btn btn-sm btn-info">Ver</a>
