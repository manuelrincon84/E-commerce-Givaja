...
<head>
    ...
    <title>Agregar Artículo al Carrito - Givaja</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h1 class="mb-4">Agregar Artículo al Carrito</h1>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('cart_id') is-invalid @enderror" id="cart_id" name="cart_id" required>
                            ...
                            @foreach($carts as $cart)
                                <option value="{{ $cart->id }}" {{ old('cart_id') == $cart->id ? 'selected' : '' }}>Carrito #{{ $cart->id }} - {{ $cart->user->first_name }}</option>
                            @endforeach
                        </select>
