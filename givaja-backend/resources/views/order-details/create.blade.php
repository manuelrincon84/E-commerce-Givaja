...
<head>
    ...
    <title>Crear Detalle de Orden - Givaja</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h1 class="mb-4">Crear Detalle de Orden</h1>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('order_id') is-invalid @enderror" id="order_id" name="order_id" required>
                            ...
                            @foreach($orders as $order)
                                <option value="{{ $order->id }}" {{ old('order_id') == $order->id ? 'selected' : '' }}>Orden #{{ $order->id }} - Cliente: {{ $order->user->first_name }}</option>
                            @endforeach
                        </select>
