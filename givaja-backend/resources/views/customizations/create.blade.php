...
<head>
    ...
    <title>Crear Personalización - Givaja</title>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h1 class="mb-4">Crear Personalización</h1>
                ...
                <form action="{{ route('customizations.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color') }}" placeholder="Ej: Rojo, Azul, etc.">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('engraving_text') is-invalid @enderror" id="engraving_text" name="engraving_text" rows="3">{{ old('engraving_text') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('extra_material') is-invalid @enderror" id="extra_material" name="extra_material" value="{{ old('extra_material') }}" placeholder="Ej: Oro, Plata, etc.">
